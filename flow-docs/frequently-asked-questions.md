...
Typ wyzwalacza|Opis
-------|--------
Sondowanie, na przykład wyzwalacz **Cykl**|Po ponownym włączeniu przepływu przetwarzane są wszystkie nieprzetworzone/oczekujące zdarzenia. Usuń przepływ, jeśli nie chcesz przetwarzać elementów oczekujących.
